...
در این پروژه فرانت‌اند سیستم مدیریت کتابخانه با JavaScript پیاده‌سازی شده است.

قابلیت‌های پیاده‌سازی‌شده

- پیاده‌سازی ورود کاربر و ارسال ایمیل و رمز عبور به API
- دریافت و ذخیره توکن JWT در Cookie با استفاده از "document.cookie"
- هدایت کاربر به Dashboard پس از ورود موفق
- محافظت از صفحات Dashboard، Books و My Loans برای کاربران واردنشده
- دریافت اطلاعات کاربر و آمار از API و نمایش آن در Dashboard
- دریافت لیست کتاب‌ها از API و نمایش اطلاعات کتاب‌ها به صورت داینامیک
- امکان امانت گرفتن کتاب‌های موجود
- غیرفعال کردن دکمه امانت برای کتاب‌های ناموجود
- ذخیره اطلاعات کتاب‌ها در "localStorage" به مدت 5 دقیقه برای کاهش درخواست‌های API
- نمایش لیست امانت‌های کاربر
- نمایش وضعیت امانت و اطلاعات کتاب
- امکان بازگرداندن کتاب
- پیاده‌سازی خروج از حساب و حذف Token و اطلاعات کاربر
- اضافه کردن حالت Loading در بخش‌های ورود، کتاب‌ها و امانت‌ها
- مدیریت خطاهای API و نمایش پیام مناسب به کاربر
- استفاده از "async/await" و "fetch" برای ارتباط با API
- استفاده از Event Listener برای مدیریت فرم ورود و عملیات امانت و بازگرداندن کتاب

ساختار JavaScript

کدهای JavaScript در پوشه "js/" به صورت جداگانه برای هر بخش قرار گرفته‌اند:

- "login.js" — مدیریت ورود و احراز هویت
- "dashboard.js" — دریافت و نمایش اطلاعات Dashboard
- "books.js" — دریافت، نمایش، کش و امانت گرفتن کتاب‌ها
- "my-loans.js" — نمایش و مدیریت امانت‌های کاربر
- "logout.js" — مدیریت خروج از حساب
---
